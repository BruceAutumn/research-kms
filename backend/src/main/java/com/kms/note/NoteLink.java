...
/**
 * note_links Index Row(Phase 4 start as Vault Index Cache, Source of truth is file content). 
 * legacy Field target_title Keep(Unresolved links and legacy backlinks Query uses). 
 */
@Entity
