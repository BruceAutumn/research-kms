...
public class Paper {
    ...
    /** AI 提取状态机：NOT_PROCESSED / QUEUED / READING / EXTRACTING / REVIEW_REQUIRED / COMPLETED / FAILED */
    ...
    /** 阅读状态：unread / reading / done（Zotero 式分诊）。 */
    @Column(name = "read_status", nullable = false, length = 16)
    private String readStatus = "unread";

    /** 处理状态：PROCESSING / READY / ERROR / DUPLICATE（产品方案 4.6 节）。 */
