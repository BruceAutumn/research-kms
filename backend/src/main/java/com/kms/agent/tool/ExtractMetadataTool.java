...
public class ExtractMetadataTool extends AbstractJsonTool {
    ...
    @Override public String displayName() { return "Metadata extract"; }
    @Override public String category() { return "Extraction"; }
    @Override public String description() { return "fromPaperFull Textextract structured metadata, and persist ai_extraction(PENDING), No direct write papers. "; }
