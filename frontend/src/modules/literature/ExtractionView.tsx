      ...
      >
        <Pane stack title="Papers" shaded>
          <div className="ext-paper-list">
            ...
            {papers.length === 0 && <p className="reader-hint">No papers</p>}
          </div>
        </Pane>
        <Handle />
        <Pane stack title="AI Extraction">
          {selectedId === null ? (
            <div className="ext-empty-state">
              ...
              <p>Select a paper on left, Run metadata extraction</p>
              <p className="reader-hint">AI resultFirstdrop ai_extraction(PENDING), Accept / Edit / Reject only after affects official Metadata. </p>
            </div>
          ) : (
            <div className="ext-main">
              <div className="ext-toolbar">
                <div className="ext-toolbar-info">
                  <span className="ext-paper-title-lg">{paper ? paper.title : 'Loading...'}</span>
